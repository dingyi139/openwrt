...
DEFAULT_PACKAGES:=base-files block-mount busybox dropbear fstools haveged libc libgcc logd msmtp mtd netifd opkg uci uclient-fetch uhttpd \
zoneinfo-asia kmod-fs-ext4 kmod-fs-f2fs kmod-fs-ntfs kmod-fs-vfat kmod-nls-cp936 kmod-usb2 kmod-usb3 kmod-usb-storage kmod-scsi-core kmod-tcp-bbr \
luci-proto-ipv6 luci-proto-ppp luci-mod-admin-full luci-app-ddns luci-app-diskman luci-app-fileassistant luci-app-firewall luci-app-frpc luci-app-frps \
luci-app-nlbwmon luci-app-samba luci-app-ttyd luci-app-wireguard luci-app-wolplus luci-theme-bootstrap
# For nas targets
